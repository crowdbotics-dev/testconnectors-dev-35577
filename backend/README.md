...
## Project Structure
    ...
    ├── testconnectors_dev_35577  # Django project configurations
...
1. Clone this repo and `cd testconnectors_dev_35577`
...
2. Clone this repo and `cd testconnectors_dev_35577`
